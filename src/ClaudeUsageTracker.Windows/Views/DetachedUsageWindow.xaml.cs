...
public partial class DetachedUsageWindow : FluentWindow
{
    ...
    public DetachedUsageWindow(UsageViewModel viewModel, UsagePollingService pollingService, TrayIconSettingsStore trayIconSettingsStore)
    {
        InitializeComponent();
    ...
    private static void SetElapsedTick(System.Windows.Controls.ColumnDefinition elapsedColumn, System.Windows.Controls.ColumnDefinition remainingColumn, DateTimeOffset resetTime, TimeSpan windowDuration)
    {
        ...
        elapsedColumn.Width   = new System.Windows.GridLength(fraction, System.Windows.GridUnitType.Star);
        remainingColumn.Width = new System.Windows.GridLength(1.0 - fraction, System.Windows.GridUnitType.Star);
    }
